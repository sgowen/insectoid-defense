...
Dialog::Dialog(std::string title, std::string leftButton, std::string rightButton) : GameObject(SCREEN_WIDTH / 2, SCREEN_HEIGHT / 2, SCREEN_WIDTH / 2, SCREEN_HEIGHT / 3, 0)
{
