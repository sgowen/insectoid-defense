...
JNIEXPORT void JNICALL Java_com_gowengamedev_insectoiddefense_platform_PlatformAssetUtils_init_1asset_1manager(JNIEnv * env, jclass jclazz, jobject java_asset_manager)
{
	UNUSED(jclazz);
