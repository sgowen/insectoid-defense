...
public final class GameActivity extends Activity
{
    ...
    public static void startActivity(Activity activity, int levelIndex, int difficulty)
    {
        Intent i = new Intent(activity, GameActivity.class);
        i.putExtra(LEVEL_INDEX, levelIndex);
        i.putExtra(DIFFICULTY_LEVEL, difficulty);
