...
IOSOpenGLESGameScreen::IOSOpenGLESGameScreen(int levelIndex, int difficulty, int screenWidth, int screenHeight, int pointsWidth, int pointsHeight) : OpenGLESGameScreen(levelIndex, difficulty)
{
