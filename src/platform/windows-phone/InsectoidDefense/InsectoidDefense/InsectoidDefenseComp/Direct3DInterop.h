...
namespace InsectoidDefenseComp
{
	...
	public:
		...
		Windows::Phone::Graphics::Interop::IDrawingSurfaceContentProvider^ CreateContentProvider(int levelIndex, int difficulty, bool isMinimumWaveRequirementMet);
	...
	private:
		...
		bool m_isMinimumWaveRequirementMet;
